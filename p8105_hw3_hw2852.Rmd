...
Using the tidied `ny_noaa_data` data set, we can determine the most commonly observed values of snowfall by first grouping the observations by `snow`, then summarising the number of observations for each `snow` value, and arranging the output in descending order. 
